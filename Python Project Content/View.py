...
class View:
    def __init__(self, top=None):
        ...
        self.isThreadRunning = False  # Initialize isThreadRunning
        self.isPlaying = False  # Initialize isPlaying
        self.song_length = 0  # Initialize song_length
        self.sel_song_index_tuple = ()  # Initialize sel_song_index_tuple
        ...
        self.songName.configure(text='''ADD ANY SONGS''')
        ...
        self._img5 = tk.PhotoImage(file="E:/SCA PROJECT/Python Project Content/icons/previous.png")
        self.previousButton.configure(image=self._img5)
        self.previousButton.configure(text='Label')  # Optional: You can remove this line if not needed
    ...
    def setup_player(self):
        try:
            ...
            if self.my_player.get_db_status():
                ...
                self.loadFavorite.config(command=self.add_song_to_favourites)
            else:
    ...
    def play_song(self):
        ...
        try:
            ...
            if not self.isThreadRunning == True:
    ...
    def load_previous_song(self):
        try:
            if hasattr(self, "sel_song_index_tuple") == False:  # for this make sure to call delattr() in play_song
